...
DESCRIPTION = (
    "שאלות מבקר המדינה, מענה ראש הממשלה והדיונים הביטחוניים שקדמו ל-7 באוקטובר 2023 — "
    "ציטוט אחר ציטוט, עם התאריך שבו נאמר. מוצג כטענות ועמדות של הדוברים, לא כקביעות של גוף בודק."
)
